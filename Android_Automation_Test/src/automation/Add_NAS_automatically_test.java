...
public class Add_NAS_automatically_test extends UiAutomatorTestCase
{
	   ...
	   public void testDemo() throws UiObjectNotFoundException {   
	      ...
	      UiObject Adddevice = new UiObject(new UiSelector()
	         .className("android.widget.RelativeLayout").resourceIdMatches("com.wdc.wd2go:id/gallery_devices_item_root"));
	      sleep(5000);
	      Adddevice.click();
